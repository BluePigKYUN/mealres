...
<body>
			...
			<div class="row g-4 content my-5 w-50" >
				<div class="border border-3 border-secondary rounded px-0 position-relative" style="height: auto; min-height: 800px">
					<div class="flex-grow-1" style="height: 50%">
						<img src="${pageContext.request.contextPath}/uploads/concernCmnt/${dto.fileName}" class="img-fluid rounded object-fit-cover" style="max-height: 460px">
					</div>
					<div class="flex-grow-1" style="height: 50%">
						 <div style="height: 75%">
	...
	$(function() {		
		$(".likeheart").click(function() {
			...
			let url = "${pageContext.request.contextPath}/concernCmnt/addlikeCmnt";
			let num  = "${dto.num}";
	...
	function listPage(page) {
		let url = "${pageContext.request.contextPath}/concernCmnt/replyList";
	...
	$(function() {
		$(".replySubmit").click(function() {
			...
			let url = "${pageContext.request.contextPath}/concernCmnt/addReply";
	...
	$(function() {
		$(".reply").on("click", ".replyDelBtn", function() {
			...
			let url = "${pageContext.request.contextPath}/concernCmnt/removeReply";
	...
	$(function() {
		$(".reply").on("click", ".adoptBtn", function() {
		...
		<script type="text/javascript">
			function deleteConcern() {
				if(confirm("글을 삭제하시겠습니까?")) {
					...
					let url = "${pageContext.request.contextPath}/concernCmnt/delete?" + query;
					location.href = url;
				}
			}
		</script>
