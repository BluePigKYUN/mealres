				...
				<div class="col-lg-12">
					<div class="row g-4">
						<div class="d-flex justify-content-between">
							...
							<c:choose>
								<c:when test="${level == '지존' || sessionScope.member.userId == 'admin'}>">
									<form name="sortForm" action="${pageContext.request.contextPath}/oMemberCmnt/list" method="post">
										<div class="ps-3 py-3 rounded mb-4 sortbox">
											<label for="oMemberSort">정렬</label> 
											<select name="oMemberSort" id="oMemberSort" class="border-0 form-select-md mx-3 oMemberSort">
												<option value="recent" ${oMemberSort=="recent" ? "selected" : ""}>최신순</option>
												<option value="hitcount" ${oMemberSort=="hitcount" ? "selected" : ""}>조회순</option>
												<option value="popular" ${oMemberSort=="popular" ? "selected" : ""}>인기순</option>
											</select>
											<input type="hidden" name="oMemberSort" value="${oMemberSort}"> 
					...
					<c:choose>
								...
								<div class="col-lg-12">
									<div class="row g-4 justify-content-start">
											...
											<c:otherwise>
												<c:forEach var="dto" items="${list}" varStatus="status">
													<div class="col-md-4 col-lg-4 col-xl-3 pb-3 mb-3" style="max-height: 800px">
														<div class="rounded position-relative oMember-item content-box" onclick="location.href='${articleUrl}&num=${dto.num}';">
															<div class="fruite-img ratio ratio-4x3">
																<img src="${pageContext.request.contextPath}/uploads/oMemberCmnt/${dto.fileName}" class="img-fluid rounded-top">
															</div>
										...
										<div style="text-align: right">
											<button type="button" class="text-white bg-secondary px-3 pt-1 rounded border-secondary" onclick="location.href='${pageContext.request.contextPath}/oMemberCmnt/write';">글쓰기</button>
										</div>
										
										<form name="searchForm" class="d-flex justify-content-center mt-5 mb-3" action="${pageContext.request.contextPath}/oMemberCmnt/list" method="post">
						...
						<c:otherwise>
							<div class="d-flex justify-content-center rounded mb-3 notOmember" style="min-height: 600px">
								<h4 class="align-content-center">우수회원만 조회할 수 있습니다.</h4>
							</div>
						</c:otherwise>
					</c:choose>
				</div>
