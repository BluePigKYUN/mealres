...
<body>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card bg-gradient-primary border border-secondary shadow rounded-lg">
                    <div class="card-body">
                        <h3 class="card-title py-3 ps-4"> 우수회원 커뮤니티 </h3>
                        ...
                        <form name="CmntForm" method="post" enctype="multipart/form-data">
                        	<div class="contentForm">
		                        ...
		                        <div class="mt-4 mb-3 me-5" style="text-align: right">
		                            ...
		                            <button type="button" class="btn border border-secondary ms-2" onclick="location.href='${pageContext.request.contextPath}/oMemberCmnt/list';">
		                                취소
		                            </button>
    ...
    <script type="text/javascript">
		$(function() {
			...
			if(file) {
				file = "${pageContext.request.contextPath}/uploads/oMemberCmnt/" + file;
		...
		function submitContents() {
			...
			form.action = "${pageContext.request.contextPath}/oMemberCmnt/${mode}";
			form.submit();
